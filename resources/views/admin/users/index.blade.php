...
<head>
    ...
    <meta name="description" content="Panel de administración de usuarios - Darketo">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full table-auto">
                        <thead class="bg-dark-200">
                            <tr>
                                <th class="py-4 px-6 text-left text-sm font-semibold text-beige">ID</th>
                                <th class="py-4 px-6 text-left text-sm font-semibold text-beige">Nombre</th>
                                <th class="py-4 px-6 text-left text-sm font-semibold text-beige">Email</th>
