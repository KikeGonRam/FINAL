...
<head>
    ...
    <meta name="description" content="Crear nuevo usuario - Panel de administración Darketo">
    <title>Crear Usuario | Darketo</title>
...
<body class="bg-dark-400 text-white font-poppins min-h-screen flex">
    ...
    <main class="flex-1 ml-64 p-8">
        <div class="max-w-2xl mx-auto">
            <!-- Header -->
            <header class="mb-8">
                <h1 class="text-3xl font-semibold text-white">Crear Nuevo Usuario</h1>
                <p class="text-gray-400 mt-2">Introduce los datos del nuevo usuario</p>
            </header>
