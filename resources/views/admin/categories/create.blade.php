...
<body class="bg-dark-400 text-white font-poppins min-h-screen flex">
    ...
    <main class="flex-1 ml-64 p-8">
        <div class="max-w-2xl mx-auto">
            <!-- Header -->
            <header class="mb-8">
                <h1 class="text-3xl font-semibold text-white">Crear Nueva Categoria</h1>
                <p class="text-gray-400 mt-2">Introduce los datos de la Categoria</p>
            </header>            
            ...
            <div class="bg-dark-300 rounded-xl shadow-xl p-6">
                <form action="{{ route('admin.categories.store') }}" method="POST" class="space-y-6">
                    @csrf
                    <div class="space-y-2">
                        <label for="name" class="block text-sm font-medium text-beige">Nombre</label>
                        <input 
                            type="text" 
                            name="name" 
                            id="name" 
                    ...
                    <div class="space-y-2">
                        <label for="description" class="block text-sm font-medium text-beige">Descripción</label>
                        <textarea
                            name="description"
                            id="description"
                            required
                            class="w-full px-4 py-2 bg-dark-200 border border-dark-100 rounded-lg focus:outline-none focus:border-beige text-white placeholder-gray-500 form-input"
                            placeholder="Ingresa una Descripcion">{{ old('description') }}</textarea>              
                    </div>
