...
<body class="bg-dark-400 text-white font-poppins min-h-screen flex">
    ...
    <main class="flex-1 ml-64 p-8">
        <div class="max-w-7xl mx-auto">
            ...
            <form method="GET" action="{{ route('admin.citas.index') }}" class="mb-4">
                <input type="text" name="search" value="{{ old('search', $search) }}" placeholder="Buscar cliente o barbero..."
            ...
            <div class="bg-dark-300 rounded-xl shadow-xl overflow-hidden">
                <div class="overflow-x-auto">
                    ...
                    <!-- Paginación -->
        <div class="mt-6">
            {{ $citas->appends(['search' => $search])->links() }}
        </div>
        </div>
    </main>
</body>
