...
<body class="bg-dark-400 text-white font-poppins min-h-screen flex">
    ...
    <main class="flex-1 ml-64 p-8">
        <div class="max-w-7xl mx-auto">
            <header class="mb-8">
                <h1 class="text-3xl font-semibold text-white">Gestión de Servicios</h1>
            </header>
        </div>
                        ...
                        <table class="w-full table-auto">
                            <thead class="bg-dark-200">
                                <tr>
                                    ...
                                    <th class="py-4 px-6 text-left text-sm font-semibold text-beige">Precio</th>
                                    <th class="py-4 px-6 text-left text-sm font-semibold text-beige">Duración</th>
                                    <th class="py-4 px-6 text-center text-sm font-semibold text-beige">Opciones</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr class="border-t border-dark-200 table-row-hover transition-colors duration-200">
                                    <td>{{ $service->name }}</td>
                                        ...
                                        <td class="py-4 px-6">${{ $service->price }} MXN</td>
                                        <td class="py-4 px-6">{{ $service->duration }} minutos</td>
                                        <td class="py-4 px-6">
