...
<body class="bg-dark-400 text-white font-poppins min-h-screen flex">
    ...
    <main class="flex-1 ml-64 p-8">
        <div class="max-w-2xl mx-auto">
            <!-- Header -->
            <header class="mb-8">
                <h1 class="text-3xl font-semibold text-white">Crear Nuevo Servicio</h1>
                <p class="text-gray-400 mt-2">Introduce los datos</p>
            </header>
                ...
                <form action="{{ route('admin.services.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" 
                                ...
                                required
                                placeholder="Ingresa el nombre del seervicio"
                                >
                    </div>
                    <div class="space-y-2">
                        <label for="name" class="block text-sm font-medium text-beige">
                        ...
                        <textarea name="description" 
                                    class="w-full px-4 py-2 bg-dark-200 border border-dark-100 rounded-lg focus:outline-none focus:border-beige text-white placeholder-gray-500 form-input"
                                    required
                                    placeholder="Ingresa el Descripcion del seervicio"
                                    >
                        </textarea>
                    </div>
                    <div class="space-y-2">
                    ...
                    <div class="space-y-2">
                        <label for="name" class="block text-sm font-medium text-beige">
                            Disponibilidad para Fechas Especiales:
                        </label>
                        <input type="checkbox" 
                                name="special_dates" 
                                value="1">
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea 
                                ...
                                class="w-full px-4 py-2 bg-dark-200 border border-dark-100 rounded-lg focus:outline-none focus:border-beige text-white placeholder-gray-500 form-input"
                                placeholder="Ingresa el paquete"
                                >
                        </textarea>
                    </div>

                    <div class="flex items-center gap-4 pt-4">
                        <button type="submit" class="px-6 py-2.5 bg-green-600 hover:bg-green-700 text-white rounded-lg transition-colors duration-300 flex items-center gap-2">
                            <i class="fas fa-user-plus"></i>
                            <span>Crear Servicio</span>
                        </button>
                        
                        <a href="{{ route('admin.services.index') }}" class="px-6 py-2.5 bg-gray-600 hover:bg-gray-700 text-white rounded-lg transition-colors duration-300 flex items-center gap-2">
