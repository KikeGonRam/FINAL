...
<body class="bg-gray-100 font-sans leading-normal tracking-normal">
    ...
    <nav class="bg-white shadow-md">
        <div class="container mx-auto flex items-center justify-between p-4">
            ...
            <button class="md:hidden p-2 text-gray-800 focus:outline-none focus:ring-2" aria-label="Toggle navigation"></button>
        </div>
    </nav>
    ...
    <div class="flex">
        ...
        <div class="flex-1 container mx-auto p-6">
            ...
            <!-- Filtro de búsqueda -->
            <form method="GET" action="{{ route('barber.citas.index') }}" class="mb-6">
                <div class="flex space-x-4">
                    <input type="text" name="search" value="{{ request('search') }}" class="w-1/3 p-2 border rounded" placeholder="Buscar por cliente o ID">
                    <select name="estado" class="w-1/3 p-2 border rounded">
            ...
            <div class="mb-6 text-center">
                <a href="{{ route('barber.citas.downloadPDF') }}" class="bg-green-600 text-white py-2 px-4 rounded-md hover:bg-green-700">
                    Descargar PDF
                </a>
            </div>
            ...
            <table class="min-w-full bg-white shadow-md rounded-md overflow-hidden">
                <thead>
                    <tr class="bg-gray-700 text-white">
                        <th class="py-2 px-4 border text-white">ID</th>
                ...
                <tbody>
                    ...
                    <tr class="hover:bg-gray-100">
                        <td class="py-2 px-4 border">{{ $cita->cliente->id }}</td>
                        <!-- Nombre del cliente -->
